  ...
  methods: {
    ...
    pickSongs(e) {
      ...
      this.songList.forEach((v, i, a) => {
        this.setBase64Content(v.file, i);
      });

      this.songList.map((v, i, a) => v.id = i);
    },

    setBase64Content(file, index) {
...
<template>
  <div class="playlist-container">
    ...
    <div class="playlist-bottom">    
      ...
      <input name="open-songs-input" id="open-songs-input" type="file" multiple="multiple" v-show="false" ref="openSongs" @change="pickSongs" />
    </div>
